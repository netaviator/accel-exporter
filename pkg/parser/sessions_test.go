...
const (
	rowVDSL  = " l66-54590#l66@bsa-vdsl | 102400/40960 | 122529 | 850000000 | 18000000000 | 900000 | 1200000\n"
	rowFTTH  = " l66-54584#l66@bsa-ftth |  | 57903 | 100 | 200 | 3 | 4\n"
...
func TestParseSessionsReadsAllColumns(t *testing.T) {
	...
	s := sessions[0]
	if s.Username != "l66-54590#l66@bsa-vdsl" {
...
func TestRealmOf(t *testing.T) {
	cases := map[string]string{
		"l66-54590#l66@bsa-vdsl": "l66@bsa-vdsl",
		"47073#level66@bsa-vdsl": "level66@bsa-vdsl",
		"customer-a":             "none",
		"trailing#":              "none",
	}
