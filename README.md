...
The labels are only the username and its realm (the part after `#`, e.g. `l66-54590#l66@bsa-vdsl`
-> `l66@bsa-vdsl`, `none` when there is none). There is deliberately no interface-name or IP label:
